<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskPage.aspx.cs" Inherits="My_Project.TaskPage" %>
    ...
    <table style="margin-right: auto; margin-top: auto; margin-bottom: auto;" class="auto-style3">
        <tr>
            <td class="auto-style13"  >
                <asp:Label ID="Label1" CssClass="auto-style6"  runat="server" Text="Project ID" Width="241px" Height="27px"></asp:Label></td>
            <td class="auto-style12">
                <asp:TextBox ID="TextBox2" CssClass="txt" Width="142px" Height="27px" runat="server" BorderWidth="2px" style="margin-left: 0%"></asp:TextBox></td>
      <td class="auto-style2">
                <asp:Label ID="Label13" CssClass="auto-style4" runat="server" Text="Task ID " Height="27px" Width="132px"></asp:Label></td>
         ...
         <tr>
            <td class="auto-style13">
                <asp:Label ID="Label2" CssClass="auto-style6" runat="server" Text="Task Name (+)" Height="27px" Width="241px"></asp:Label></td>
         ...
         <td class="auto-style2">
                <asp:Label ID="Label7" CssClass="auto-style4" runat="server" Text="Task Name (+)" Height="27px" Width="123px"></asp:Label></td>
            <td>
       ...
       <td class="auto-style2">
                <asp:Label ID="Label8" CssClass="auto-style4" runat="server" Text="Task Name (+)" Height="27px" Width="123px"></asp:Label></td>
            <td>
        ...
        <td class="auto-style2">
                <asp:Label ID="Label9" CssClass="auto-style4" runat="server" Text="Task Name (+)" Height="27px" Width="123px"></asp:Label></td>
            <td>
        ...
        <td class="auto-style2">
                <asp:Label ID="Label10" CssClass="auto-style4" runat="server" Text="Task Name (+)" Height="27px" Width="123px"></asp:Label></td>
            <td>
        ...
        <td class="auto-style2">
                <asp:Label ID="Label11" CssClass="auto-style4" runat="server" Text="Task Name (+)" Height="27px" Width="123px"></asp:Label></td>
            <td>
        ...
        <td class="auto-style10">
            <asp:Button ID="Button1"  CssClass="auto-style11" runat="server" Text="Save" Height="38px" Width="68px" style="margin-left: 70%" OnClick="Button1_Click"  />
                </td>
            <td class="auto-style10">
