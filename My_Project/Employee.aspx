<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Employee.aspx.cs" Inherits="My_Project.Employee" %>
       ...
       <div class ="container1">
           <div class="innerx" >
               ...
               <a href="Fileupload.aspx" class="aa">Upload & Download File</a>
                <br />
               <br />
               <a href="Employee.asp" class="aa">User Profile Page</a>
               <br />
               <br />
           ...
           <div class="inner1">
               ...
               <asp:TextBox ID="Textnic" placeholder="NIC"  runat="server"></asp:TextBox>
               
               <asp:TextBox ID="Textfull" placeholder="Full Name" runat="server"></asp:TextBox>
               
               
               <asp:TextBox ID="Textadd" placeholder="Address" runat="server"></asp:TextBox>
               <asp:TextBox ID="Textdob" placeholder="Date Of Birth in ( mm/ dd/ yyyy) format" runat="server"></asp:TextBox>
               <asp:TextBox ID="Textmobile" placeholder="Mobile Number" runat="server"></asp:TextBox>
